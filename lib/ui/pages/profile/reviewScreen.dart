                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        formatter.format(((wallpaper.data()
                                as dynamic)["createdAt"] as Timestamp)
                            .toDate()
                            .toLocal()),
                        style: Theme.of(context)
                            .textTheme
                          ...
                          child: SizedBox(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: (wallpaper.data()
                                  as dynamic)["wallpaper_thumb"] as String,
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  "${(wallpaper.data() as dynamic)["size"]}",
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyText2!
                                      .copyWith(
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  "${(wallpaper.data() as dynamic)["resolution"]}",
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyText2!
                                      .copyWith(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      constraints: BoxConstraints(
        minHeight: "${(wallpaper.data() as dynamic)["widget2"]}" != "" &&
                "${(wallpaper.data() as dynamic)["widget2"]}" != null
            ? 420
            : 390,
        maxHeight: "${(wallpaper.data() as dynamic)["widget2"]}" != "" &&
                "${(wallpaper.data() as dynamic)["widget2"]}" != null
            ? 470
            : 440,
      ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        formatter.format(((wallpaper.data()
                                as dynamic)["created_at"] as Timestamp)
                            .toDate()
                            .toLocal()),
                        style: Theme.of(context)
                            .textTheme
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                toasts.codeSend(
                                    "${(wallpaper.data() as dynamic)["name"]} - ${(wallpaper.data() as dynamic)["desc"]}");
                              },
                              child: SizedBox(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text:
                                          "${(wallpaper.data() as dynamic)["name"]}",
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText2!
                                          .copyWith(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              " - ${(wallpaper.data() as dynamic)["desc"]}",
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyText2!
                                              .copyWith(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                if ("${(wallpaper.data() as dynamic)["wallpaper_url"]}"[
                                        0] !=
                                    "[") {
                                  if ("${(wallpaper.data() as dynamic)["wall_id"]}" !=
                                          "" &&
                                      "${(wallpaper.data() as dynamic)["wall_id"]}" !=
                                          null) {
                                    Navigator.push(
                                        context,
                                        CupertinoPageRoute(
                                    ...
                                    launch("${(wallpaper.data() as dynamic)["wallpaper_url"]}")
                                        .catchError((e) {
                                      toasts.error("Error in link!");
                                    });
                                  }
                                } else {
                                  launch("${(wallpaper.data() as dynamic)["wallpaper_url"][1]}")
                                      .catchError((e) {
                                    toasts.error("Error in link!");
                                  });
                                }
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width:
                                        MediaQuery.of(context).size.width * 0.3,
                                    child: Text(
                                      "${(wallpaper.data() as dynamic)["wallpaper_url"]}"[
                                                  0] !=
                                              "["
                                          ? "Wallpaper"
                                          : "${(wallpaper.data() as dynamic)["wallpaper_url"][0]} - ${(wallpaper.data() as dynamic)["wallpaper_url"][2]}",
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText2!
                                          .copyWith(
                            ...
                            GestureDetector(
                              onTap: () {
                                launch("${(wallpaper.data() as dynamic)["icon_url"]}")
                                    .catchError((e) {
                                  toasts.error("Error in link!");
                                });
                              },
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width:
                                        MediaQuery.of(context).size.width * 0.3,
                                    child: Text(
                                      "${(wallpaper.data() as dynamic)["icon"]}",
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText2!
                                          .copyWith(
                            ...
                            if ("${(wallpaper.data() as dynamic)["widget"]}" !=
                                    "" &&
                                "${(wallpaper.data() as dynamic)["widget"]}" !=
                                    null)
                              const SizedBox(
                                height: 16,
                              )
                            ...
                            if ("${(wallpaper.data() as dynamic)["widget"]}" !=
                              ...
                              GestureDetector(
                                onTap: () {
                                  launch("${(wallpaper.data() as dynamic)["widget_url"]}")
                                      .catchError((e) {
                                    toasts.error("Error in link!");
                                  });
                                },
                              ...
                              Container(),
                            if ("${(wallpaper.data() as dynamic)["widget2"]}" !=
                                    "" &&
                                "${(wallpaper.data() as dynamic)["widget2"]}" !=
                                    null)
                              const SizedBox(
                                height: 16,
                              )
                            ...
                            if ("${(wallpaper.data() as dynamic)["widget2"]}" !=
                              ...
                              GestureDetector(
                                onTap: () {
                                  launch("${(wallpaper.data() as dynamic)["widget_url2"]}")
                                      .catchError((e) {
                                    toasts.error("Error in link!");
                                  });
                                },
                                ...
                                Container(
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      final link =
                                          (wallpaper.data() as dynamic)["image"]
                                              .toString();
                                      debugPrint(link);
...
class RejectedSetupTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: MediaQuery.of(context).size.width,
      height: "${(wallpaper.data() as dynamic)["widget2"]}" != "" &&
              "${(wallpaper.data() as dynamic)["widget2"]}" != null
          ? 460
          : 430,
      margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
