...
import 'package:wetune/data/informatics/dataManager.dart';
import 'package:wetune/data/profile/wallpaper/getUserProfile.dart' as user_data;
...
import 'package:wetune/ui/widgets/home/core/collapsedPanel.dart';
import 'package:wetune/ui/widgets/home/wallpapers/clockSetupOverlay.dart';
import 'package:wetune/ui/widgets/menuButton/downloadButton.dart';
...
import 'package:wetune/ui/widgets/animated/showUp.dart';
                                  ...
                                  children: [
                                    SetupDetailsTile(
                                      ...
                                      tileText: (Provider.of<user_data.UserProfileProvider>(
                                              ...
                                              "["
                                          ? "Prism"
                                          : "${(Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].data()! as dynamic)["wallpaper_url"][0]} - ${((Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].data()! as dynamic)["wallpaper_url"] as List).length > 2 ? (Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].data()! as dynamic)["wallpaper_url"][2].toString() : ""}",
                                      tileType: "Wallpaper",
                                      panelCollapsed: panelCollapsed,
        ...
        : GestureDetector(
            onTap: () async {
              launch((Provider.of<user_data.UserProfileProvider>(context,
                          listen: false)
                      .userProfileSetups![index!]
                      .data()! as dynamic)["wallpaper_url"][1]
                  .toString());
            },
            child: Container(
              decoration: BoxDecoration(
